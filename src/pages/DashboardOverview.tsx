...
export default function DashboardOverview() {
  ...
  // Show top 5 by score for the overview
    ...
    <div className="p-6 flex flex-col gap-6">
      ...
      <div className="rounded-xl border border-white/8 bg-brand-card overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/5">
          <div>
            <h2 className="font-display text-lg text-white">Top Priority Leads</h2>
            <p className="font-body text-white/30 text-xs mt-0.5">Ranked by lead score</p>
          </div>
          <Link
            to="/dashboard/leads"
          ...
          {isLoading
            ...
            : topLeads.map((lead) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <ScoreBadge score={lead.score ?? 0} showLabel />
          ...
          {[
            ...
            <div key={item.label} className="flex items-center gap-3">
              ...
              <div className="flex-1 h-2 rounded-full bg-white/5 overflow-hidden">
                <div
                  className={`h-full rounded-full transition-all duration-700 ${item.color} ${isLoading ? 'animate-pulse' : ''}`}
